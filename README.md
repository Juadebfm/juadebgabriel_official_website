<div align="center">
  ...
  <h3 align="center">Personal Portfolio Website</h3>
   ...
   <div align="center">
     Built this project off inspiration from <a href="https://www.behance.net/arthurmoldovanu" target="_blank"><b>Arthur Menkhyn</b></a>
    </div>
</div>
...
Built on Next.js 14, this web application stands as my 2024 version of my personal portfolio wevsite. I've had several versions of the [Juadebgabriel Website](https://www.juadebgabriel.com). This one happens to be my favorite because this time i built it without actually using a pre-determined design in mind. Just took ideas from various websites. So i'll call this a MASHUP.

## <a name="tech-stack">⚙️ Tech Stack</a>

- Next.js
- TailwindCSS
- Formspree (Contact Form & Form Validation)
- Lottie Web Animations
- AOS Animation Library

## <a name="features">🔋 Features</a>

👉 **Basic** Nothing serious for now, i might go crazy on it later.
